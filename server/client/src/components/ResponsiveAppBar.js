...
function ResponsiveAppBar() {
    ...
    const [user, setUser] = React.useState({
        name: 'Guest',
        image: '/static/images/avatar/2.jpg', // Default image or placeholder
    });
        ...
        <AppBar position="static">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    <RssFeed sx={{ display: { xs: 'none', md: 'flex' }, mr: 1 }} />
                    <Typography
                        variant="h6"
                        noWrap
                        component="a"
                    ...
                    <Box sx={{ flexGrow: 0 }}>
                        <Tooltip title="Open settings">
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                <Avatar alt={user.name} src={user.image} /> {/* User icon or profile image */}
                            </IconButton>
                        </Tooltip>
                        <Menu
                            sx={{ mt: '45px' }}
