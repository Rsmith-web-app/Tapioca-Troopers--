    ...
    return(
        <Box sx= {{minHeight: '150vh', display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
            ...
            <Container>
                ...
                <Typography variant="h6" align="center" style= {{marginBottom: '70px'}}>
                    <h4>below is a guide to each tab you can access through the menu bar, as well as the most recent posts!</h4>
                </Typography>
                ...
                <Box sx={{flex: 1, maxWidth: '400px'}}> 
                    <br/>
                    <ul>
                        <li style={{ marginBottom: '24px' }}><b>Home:</b> this will take you back here</li>
